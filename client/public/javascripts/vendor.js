...
}).call(this);(function(a){var b,c=function(){},d="assert,count,debug,dir,dirxml,error,exception,group,groupCollapsed,groupEnd,info,log,markTimeline,profile,profileEnd,time,timeEnd,trace,warn".split(",");while(b=d.pop())a[b]=a[b]||c})(window.console=window.console||{});
