  ...
  (function() {
    ...
    exports.Note = (function(_super) {
      ...
      function Note(note) {
        ...
        if (typeof this.path === "string") this.path = JSON.parse(this.path);
        slugs = [];
        if (this.path != null) {
          _ref = this.path;
    ...
    exports.HomeView = (function(_super) {
      ...
      */
      ...
      HomeView.prototype.onIFrameLoaded = function() {
        ...
        if (this.treeLoaded) this.selectNote(note_uuid);
      ...
      HomeView.prototype.selectNoteIfIframeLoaded = function() {
        this.treeLoaded = true;
        if (this.iframeLoaded) return this.selectNote(this.note_uuid);
      };
      ...
      HomeView.prototype.onTreeRename = function(uuid, newName) {
        if (newName != null) {
          ...
          return Note.updateNote(uuid, {
            ...
            if (err) return alert("Server error occured");
          });
        }
      };
      ...
      */
      ...
      HomeView.prototype.selectNote = function(noteId) {
        ...
        if (!(noteId != null) || (noteId === "all" || noteId === 'tree-node-all') || noteId.length === 0) {
          this.helpInfo.show();
          this.noteFull.hide();
          if ((_ref = this.tree) != null) _ref.widget.jstree("search", "");
      ...
      */
      ...
      NoteView.prototype.setTitleListeners = function() {
        ...
        this.noteFullTitle.live("keypress", function(event) {
          if (event.keyCode === 13) return noteFullTitle.trigger("blur");
        });
...
window.require.define({"views/templates/editor": function(exports, require, module) {
  ...
  var interp;
  buf.push('<div');
  buf.push(attrs({ 'id':('editor-button-bar'), "class": ('btn-group') + ' ' + ('btn-group-vertical') + ' ' + ('clearfix') }));
  buf.push('><button');
  ...
  buf.push('></i></button></div><div');
  buf.push(attrs({ "class": ('spacer') }));
  buf.push('></div><div');
  buf.push(attrs({ 'id':('note-file-list') }));
  buf.push('><div');
  buf.push(attrs({ 'id':('file-number') }));
  buf.push('>0 files</div><div');
  buf.push(attrs({ 'id':('file-pic') }));
  buf.push('></div><div');
...
window.require.define({"views/templates/home": function(exports, require, module) {
  ...
  buf.push('><div');
  buf.push(attrs({ 'id':('search-view') }));
  buf.push('></div><div');
  buf.push(attrs({ 'id':('help-info') }));
  buf.push('>You don\'t have any note selected yet. To select a note use the tree\non your left.\n</div><div');
  buf.push(attrs({ 'id':('note-full'), "class": ('note-full') }));
  buf.push('><div');
  buf.push(attrs({ 'id':('note-full-breadcrumb') }));
  buf.push('>/</div><div');
  buf.push(attrs({ 'id':('note-style') }));
  buf.push('><div');
  buf.push(attrs({ "class": ('no-padding') }));
  buf.push('><input');
  ...
  buf.push('><p>You are about to delete this note and all its children. Do you want to continue?</p></div><div');
  buf.push(attrs({ "class": ('modal-footer') }));
  buf.push('><button');
  buf.push(attrs({ 'id':('modal-yes'), 'data-dismiss':("modal"), 'aria-hidden':("true"), "class": ('btn') }));
...
window.require.define({"views/templates/search_result": function(exports, require, module) {
  module.exports = function anonymous(locals, attrs, escape, rethrow) {
  var attrs = jade.attrs, escape = jade.escape, rethrow = jade.rethrow;
  var buf = [];
  with (locals || {}) {
  var interp;
  buf.push('<div');
  buf.push(attrs({ "class": ('search-result') }));
  buf.push('><h2><a');
  buf.push(attrs({ 'href':("#note/" + (note.id) + "/" + (note.slugPath) + "") }));
  buf.push('>' + escape((interp = note.title) == null ? '' : interp) + '</a></h2><p>' + escape((interp = note.preview) == null ? '' : interp) + ' \n</p></div>');
  }
  return buf.join("");
  };
}});

window.require.define({"views/templates/search_view": function(exports, require, module) {
  module.exports = function anonymous(locals, attrs, escape, rethrow) {
  var attrs = jade.attrs, escape = jade.escape, rethrow = jade.rethrow;
  var buf = [];
  with (locals || {}) {
  var interp;
  buf.push('<h1>Search results for<span></span></h1><div');
  buf.push(attrs({ "class": ('results') }));
  buf.push('></div>');
  }
  return buf.join("");
  };
...
window.require.define({"views/templates/tree_buttons": function(exports, require, module) {
  ...
  buf.push('></i></div><div');
  buf.push(attrs({ 'id':('my-notes') }));
  buf.push('><img');
  buf.push(attrs({ 'id':('my-notes-pic'), 'src':("img/my-notes.png") }));
  buf.push('/><div');
  buf.push(attrs({ 'id':('create-note') }));
  buf.push('></div></div>');
  }
  return buf.join("");
  };
  ...
  (function() {
    ...
    exports.FileList = (function(_super) {
      ...
      FileList.prototype.onUploadComplete = function(id, filename, response) {
        var _this = this;
        if (!(this.model._attachments != null)) this.model._attachments = {};
            ...
            core: {
              ...
              */
              onGetFormData: function(e, data, keyCode) {
                ...
                if (textInput === "") return searchFunction("");
              }
            },
            autocomplete: {
              /**
      ...
      */
      ...
      Tree.prototype._updateSuggestionList = function(action, newName, oldName) {
        ...
        if (action === "create") {
          ...
          if (suggestionList.length > i) return suggestionList.splice(i, 1);
        }
      };
