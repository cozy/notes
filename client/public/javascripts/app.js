    ...
    exports.CNEditor = (function(_super) {
      ...
      */
      ...
      CNEditor.prototype._moveLinesUp = function() {
        var cloneLine, line, lineEnd, lineNext, linePrev, lineStart, myRange, numOfUntab, savedSel, secondL, sel, _results, _results2;
        this._findLines();
        sel = this.currentSel;
        lineStart = sel.startLine;
        lineEnd = sel.endLine;
...
window.require.define({"views/editor_old": function(exports, require, module) {
    ...
    exports.Tree = (function() {
      ...
      Tree.prototype.setListeners = function(callbacks) {
        ...
        $("#note-full-title").live("keypress", function(e) {
          if (e.keyCode === 13) {
            return $("#note-full-title").trigger("blur");
